...
import io.github.lmqvq.lldcard.backend.service.OrderService;
import io.github.lmqvq.lldcard.backend.service.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<Map<String, Object>> pay(@RequestBody Map<String, String> payload) {
        ...
        try {
            ...
            return ResponseEntity.badRequest().body(Map.of("success", false, "message", "支付请求失败"));
        }
    }
