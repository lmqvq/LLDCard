...
import io.github.lmqvq.lldcard.backend.dto.LoginRequest;
...
import io.github.lmqvq.lldcard.backend.dto.TokenRefreshRequest;
import io.github.lmqvq.lldcard.backend.service.AuthService;
import io.github.lmqvq.lldcard.backend.service.SettingsService;
...
public class AuthController {
    ...
    public LoginResponse loginAdmin(@RequestBody LoginRequest request) {
        try {
            ...
            return LoginResponse.error("登录失败，请稍后重试");
        }
    }
