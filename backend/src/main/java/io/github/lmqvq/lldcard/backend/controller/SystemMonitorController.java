...
import io.github.lmqvq.lldcard.backend.service.SystemMonitorService;
...
public class SystemMonitorController {
    ...
    public ResponseEntity<?> checkUpdate() {
        try {
            String url = "https://raw.githubusercontent.com/lmqvq/LLDCard/main/public/version.json";
            ...
            return ResponseEntity.internalServerError().body(Map.of("error", "检查更新失败"));
        }
    }
}
