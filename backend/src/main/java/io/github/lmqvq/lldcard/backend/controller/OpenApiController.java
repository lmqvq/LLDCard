...
import io.github.lmqvq.lldcard.backend.service.ApiKeyService;
import io.github.lmqvq.lldcard.backend.service.CardService;
...
public class OpenApiController {
    ...
    private final io.github.lmqvq.lldcard.backend.util.CustomCardObfuscator customCardObfuscator;

    public OpenApiController(ApiKeyService apiKeyService, CardService cardService, io.github.lmqvq.lldcard.backend.util.CustomCardObfuscator customCardObfuscator) {
